                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin?')" href="hapus.php?id_kasir=<?= $res['id_kasir'] ?>">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                   </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="kasir" class="btn btn-primary">Save</button>
        </form>
      </div>
    </div>
  </div>
