...
if(isset($_POST['konsumen'])) {
  ...
  $username =  strip_tags(strtoupper(htmlentities($_POST['username'])));
  $password =  strip_tags(strtoupper(htmlentities($_POST['password'])));
  // $alamat = $_SESSION['id']''

  $query = "INSERT INTO konsumen(nama_kon,telp,alamat,user_kon,password) VALUES ('$nama','$no_telp','$alamat','$username','$password')";
                                      ...
                                      while($res = mysqli_fetch_assoc($exec)) { ?>
                                        <tr>
                                          ...
                                          <td><?= $res['nama_kon'] ?></td>
                                           ...
                                           <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin?')" href="hapus.php?id_kon=<?= $res['id_kon'] ?>">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                   </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="datakonsumen.php" method="POST">
        	<input class="form-control mb-2" type="text" name="nama" placeholder="Customer Name">
          <input class="form-control mb-2" type="text" name="no_telp" placeholder="Number">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="konsumen" class="btn btn-primary">Save</button>
        </form>
      </div>
    </div>
  </div>
