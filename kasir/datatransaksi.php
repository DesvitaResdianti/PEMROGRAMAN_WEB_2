                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	<?php $query = "SELECT trx.*,konsumen.*,kasir.*, disc.*, status_transaksi.* from trx, konsumen, kasir , disc, status_transaksi WHERE trx.id_kon=konsumen.id_kon AND trx.id_kasir=kasir.id_kasir and trx.id_discount=disc.id_disc and trx.status_transaksi=status_transaksi.id_transaksi ORDER BY id_trx DESC";
