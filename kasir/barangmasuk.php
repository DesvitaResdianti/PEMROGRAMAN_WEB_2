...
if(isset($_POST['barang'])) {
 ...
 $query = "INSERT INTO trxbarang(tgl_trx,id_brg,jml) VALUES ('$tanggal','$namabarang','$jumlah')";
...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Return Stock</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                              <?php $query = "SELECT trxbarang.*,product.* FROM trxbarang,product WHERE trxbarang.id_brg = product.id_brg  ORDER BY trxbarang.tgl_trx DESC";
                            		$exec = mysqli_query($conn,$query);
...
<!--                                             <td><?= $res['id_trx'] ?></td> -->
                                           ...
                                           <td>
                                           <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin?')" href="hapus.php?id_trx=<?= $res['id_trx'] ?>">Delete</a></td>
                                        </tr>
                                        <?php } ?>
                                   </tbody>
