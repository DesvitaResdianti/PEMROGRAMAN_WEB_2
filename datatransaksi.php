                            ...
                            <div class="table-responsive">
                               ...
                               $trx = mysqli_fetch_array($sql2);
                                 ...
                                 $query = "";
                                  ...
                                  {
                                    $query = "SELECT trx.*,konsumen.*,kasir.*,disc.*,status_transaksi.* from trx, konsumen, kasir, disc, status_transaksi WHERE trx.id_kon=konsumen.id_kon AND trx.id_kasir=kasir.id_kasir and trx.status_transaksi=status_transaksi.id_transaksi and trx.id_discount=disc.id_disc and trx.status_transaksi!=1 ORDER BY id_trx DESC";
