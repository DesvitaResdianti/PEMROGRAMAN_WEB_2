                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                 <img width="100%" height="100%" src="foto/toko.jpg">
                            </div>
                            <div class="col-md-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= $ress['nama_toko'] ?>" required name="nama" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Enter Username...">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" value="<?= $ress['alamat'] ?>" required name="alamat" class="form-control form-control-user"
